...
class DataFormatting():
    ...
    def dataset(df):
        ...
        df_data = df[['open','high','low','close','CPI','INTEREST_RATE']]
        df_datetime =df[['date']]
...
if __name__ == '__main__':
    ...
    # paths
    SCALING_PATH = 'scaler_std.bin'
    CSV_PATH = '../data/macro_data/XAUUSD_forecast.csv'
    MODEL_PATH = "../Model_Outputs/2022_11_13/final_run/model_Bilstm/model/lstm_.h5"
